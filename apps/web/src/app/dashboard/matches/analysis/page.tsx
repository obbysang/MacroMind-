      ...
      <header className="flex items-center justify-between whitespace-nowrap border-b border-white/5 bg-match-surface-darker px-8 py-3 shrink-0 z-20">
        <div className="flex items-center gap-8">
          ...
          <div className="flex items-center gap-4 text-white">
            <Link href="/dashboard/matches" className="size-8 flex items-center justify-center rounded-full hover:bg-white/10 transition-colors cursor-pointer" aria-label="Back to matches">
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden scrollbar-hide p-6 lg:px-10 pb-10">
        <div className="max-w-[1600px] mx-auto flex flex-col gap-6">
          ...
          <div className="flex flex-wrap gap-2 text-sm">
            <Link className="text-[#9db0b9] hover:text-white transition-colors" href="/dashboard">Home</Link>
            <span className="text-[#9db0b9] opacity-50">/</span>
            <Link className="text-[#9db0b9] hover:text-white transition-colors" href="/dashboard/scrims">Scrims</Link>
            <span className="text-[#9db0b9] opacity-50">/</span>
